-- =====================================================
-- REMOVE ABANDONMENT VICTORY NOTIFICATION
-- =====================================================
-- Users don't need a notification when they win by abandonment
-- They'll see the result modal on the game page
    ...
    IF v_session.id IS NOT NULL THEN
      ...
      IF v_remaining_players <= 1 THEN
        ...
        BEGIN
          ...
          -- DO NOT create notification - user will see result modal on game page
